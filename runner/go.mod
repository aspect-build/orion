module github.com/aspect-build/orion/runner

// NOTE: use 2 replaces to avoid 'bazel mod tidy' adding an extra invalid
// entry to the MODULE use_repo().
replace github.com/aspect-build/orion/language => ../language
replace github.com/aspect-build/orion/common => ../common

go 1.24.5

require (
	github.com/EngFlow/gazelle_cc v0.1.0 // NOTE: keep in sync with MODULE.bazel
	github.com/aspect-build/orion v0.0.0-00010101000000-000000000000
