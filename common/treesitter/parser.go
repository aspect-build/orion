...
<<<<<<< HEAD:cli/core/gazelle/common/treesitter/parser.go
...
=======
	golang "github.com/aspect-build/orion/common/treesitter/grammars/golang"
	"github.com/aspect-build/orion/common/treesitter/grammars/java"
	"github.com/aspect-build/orion/common/treesitter/grammars/json"
	"github.com/aspect-build/orion/common/treesitter/grammars/kotlin"
	"github.com/aspect-build/orion/common/treesitter/grammars/rust"
	"github.com/aspect-build/orion/common/treesitter/grammars/starlark"
	"github.com/aspect-build/orion/common/treesitter/grammars/tsx"
	"github.com/aspect-build/orion/common/treesitter/grammars/typescript"
>>>>>>> 9fcbbfb2 (rename github.com/aspect-build/{silo => orion} go packages):common/treesitter/parser.go
