...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:/gh8S450+nfr3wYI6bTYEi297obbVcMObavhPuB7LVo=",
        version = "v0.26.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:w+8uO/Fk87q87cePbL8Qir+iETYOfmoqGi0VmG2V/g8=",
        version = "v0.0.0-20220830143905-2a9bddb5c3a7",
    )
    ...
    go_repository(
        ...
        sum = "h1:ZmngSVLe/wycRns9MKikG9OWIEjGcGAkacif7oYQaUY=",
