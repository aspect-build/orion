...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:4yWIHXOLEJHQEFd4UjrWDrYeYlV7ncFWJOCBRLOZHQg=",
        version = "v1.4.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JNWpkjImTP2e308bv7ihfwgOawf640BY/pyZWrBb9rw=",
        version = "v1.36.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XWuWBRFEpqVrHepQob9yPS3Xg4K3Wr9QCx4fu8HbUNg=",
        version = "v2.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:08p6611HADinUwK0oyxCaAsnFXVDU4GlTW1TdXVP+5s=",
    ...
    go_repository(
        ...
        sum = "h1:kCg7B+jSCFPLYRA52SDZjr51kG/fMUEoPoZrkaDHyoI=",
        version = "v1.3.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:1Hm3wxww7qXvGI+Fb3zDmIZo5oDOvVOWJ4OrIB+ef7c=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:f/tgjaf9cdsNI9kg3yg3NUs23Q/0YQn6omWdHZtCTRc=",
        version = "v0.0.0-20250315225456-0761ac7eb2e8",
    )
    go_repository(
    ...
    go_repository(
        ...
        patches = [
            "//cli/core:patches/com_github_cloudflare_circl/fp25519.patch",
            "//cli/core:patches/com_github_cloudflare_circl/fp448.patch",
            "//cli/core:patches/com_github_cloudflare_circl/x25519.patch",
            "//cli/core:patches/com_github_cloudflare_circl/x448.patch",
        ],
    ...
    go_repository(
        ...
        sum = "h1:8SR2DB391dw0HVI9572ElrY+KU0Q89OCXYwWZx7aAZc=",
        version = "v1.7.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IXRULR8mAa0MXQobzzp0VOfMUJ8EnaQ4x3jhf7S0/nI=",
        version = "v1.13.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_google_slowjam",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/google/slowjam",
        sum = "h1:dA9flW4oGTJcSy8FpEvdq8JKwPFVgqYwMmjhqlb2L+s=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_google_triage_party",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/google/triage-party",
        patch_args = ["-p1"],  # keep
        patches = ["//third_party:github.com/google/triage_party/file_groups.patch"],  # keep
    ...
    go_repository(
        ...
        sum = "h1:KxsIcqivuZu1VnrQRTSWdKgu/5CeryWzjakR81XSIBs=",
        version = "v0.0.0-20200501161113-5e9e23d7cb91",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:t5y/7QOHYgf/VJNCKiCH3O5VECAn8/iN5x73icbFzKQ=",
        version = "v0.6.2-0.20250317013600-8a6092d5e4ff",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:92Aw44hjSK4MxJeMSyDa7jwuI9GR2J/JCQiaKvXXSlk=",
        version = "v1.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:EW+HjKEVa55pUYFJseEHEHdQ0+ulunY+q42zF3M7ZaQ=",
        version = "v4.45.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_reva2_bitbucket_insights_api",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/reva2/bitbucket-insights-api",
        sum = "h1:lpQ/Q7OmnG04w/EM77piOwZBxP41PeTlbytXxVrnplA=",
        version = "v1.0.0",
    )
    go_repository(
        ...
        sum = "h1:wFzV+/KigR9v01F8+cK/QyaMg6NgyfOOZaSquborhpY=",
        version = "v0.0.0-20240608101709-1d3280ed6bd4",
    )
    go_repository(
        name = "com_github_reviewdog_go_bitbucket",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/reviewdog/go-bitbucket",
        sum = "h1:XZ60Bp2UqwaJ6fDQExoFVrgs4nIzwBCy9ct6GCj9hH8=",
    ...
    go_repository(
        ...
        sum = "h1:TmALdYHnU57HKfDbWbbUO9xqsqxQz6JDkY/cEpbphRw=",
        version = "v0.17.4",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_vvakame_sdlog",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/vvakame/sdlog",
        sum = "h1:gwZRXZ0EmhJQJN/Do/+PTQigcmFiSqZ07aDjxqGOLT8=",
        version = "v1.2.0",
    )
    go_repository(
        ...
        sum = "h1:3nyLq0ESez0crcaM19o5S//SvezOQguuIHZ3wgX64hM=",
        version = "v0.105.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:+zZrwVmujIrgobt6wVBWCqITz6bn1aBjnCUHmpZrerI=",
        version = "v0.18.0",
    )
    go_repository(
        name = "io_k8s_klog_v2",
    ...
    go_repository(
        ...
        sum = "h1:yMJe4SyVd1CYtjYLH/THl39sCe5bRbwvjEDLBIjqBpk=",
        version = "v0.0.0-20230906094020-6ed658a430ec",
    )
    go_repository(
