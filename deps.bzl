...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:CWwMI1iJu/db1Jpczn6VMcnhVvHsF+kLgKtYGzc/+8U=",
        version = "v0.21.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:h592I+2eJfXj/4jVYM+tu9Rv8FEc/dyCoD80UJlMW2Y=",
        version = "v0.27.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:oK7+AlwBKsSUIIRC5Vv8/4HEtmgzXNQD+zLbsOUwVso=",
        version = "v0.27.3",
    )
    go_repository(
        name = "io_k8s_cri_api",
    ...
    go_repository(
        ...
        sum = "h1:HyC4o+8rCYheGDWrkcOQHGwDmyLKR5bxXFgpvF82BOw=",
        version = "v0.27.3",
    )
    go_repository(
        name = "io_k8s_metrics",
        ...
        sum = "h1:pBVKgQjfui8xzfTidIxiOmLHwcCk3KbeuWowo/Oh0t0=",
        version = "v0.27.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5y1+Sbty12t48T/t/CGNYUIME5BJ0WKfmW/sobYqkFg=",
        version = "v3.12.3",
    )
    go_repository(
