...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:G56Bp6mU0b5HE1SkaoVjscZjlQb0oy4mezwY/cGH19w=",
        version = "v4.3.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:x6kNDO1LtWyTyhys9m899tWm8PzOxUs3Lu6zuwClghg=",
        version = "v1.16.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        patches = ["//patches:com_github_bazelbuild_remote_apis.patch"],  # keep
    ...
    go_repository(
        name = "com_github_buildbarn_bb_clientd",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/buildbarn/bb-clientd",
        sum = "h1:5ljsDc/BWRQgBvcXIpXXDiUapWIimMeybBhHDrSuLTU=",
        version = "v0.0.0-20230208184232-939beb99dc15",
    )
    go_repository(
        name = "com_github_buildbarn_bb_remote_execution",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/buildbarn/bb-remote-execution",
        sum = "h1:Z1il/Zwbyn+sniKC527qGiRjAMysSPfIqhJXIOZlMvg=",
        version = "v0.0.0-20230213172655-e0ae60c4312e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QzE7cRRq7y3qH7ZKGN0/nUGbdZPyikfNaMaCMNUufnU=",
        version = "v0.17.8",
    )
    go_repository(
    ...
    go_repository(
        ...
        patches = ["//patches:com_github_google_go_jsonnet.patch"],  # keep
    ...
    go_repository(
        ...
        sum = "h1:TYNAU9lu7ggdAereRq0dzCIDzHu9mNyGLj/hd5PXq8I=",
        version = "v0.0.0-20220928193011-d2c82e48359b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qi6wMDUEwRJy1YUDBna2gMzeOuor3cnCdkslJpt8lsI=",
        version = "v0.0.0-20201112025421-5694020ddb6a",
    )
    ...
    go_repository(
        ...
        sum = "h1:xFTEVwOFa1D/Ty24Ws1npBWkDYEV9BqZrsDxVrVkrrU=",
        version = "v2.8.1",
    )
    go_repository(
        ...
        sum = "h1:QLidEla4bXUuZVFa4KX6JHCsuGgbi85LC/pCHrt/O08=",
        version = "v1.27.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:V5CF5qPem5OGSnEo8BoSbsDGwejg6VUJsKEdneaoTUo=",
        version = "v1.7.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:sOjDVHxNTuM6dNGaba0wUuz7KvDE1BmNu9Gqs2gJSXQ=",
        version = "v1.1.12",
    )
    go_repository(
        ...
        sum = "h1:m/CM1UfOkoBTglGO5CUTKnIKKOApOYxkcP2qn0F9tJk=",
        version = "v1.1.12",
    )
    go_repository(
        ...
        sum = "h1:Ud31nqZmebcQpl151nb108+vtcpxJ7kfXmbPYbALBiI=",
        version = "v1.1.12",
    )
    go_repository(
        ...
        sum = "h1:3rRWB1GK0psTJrHwxzNfEij2MLibggiLdTqjTtfHc1w=",
        version = "v1.1.12",
    )
    go_repository(
        name = "com_github_uptrace_bun_driver_sqliteshim",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/uptrace/bun/driver/sqliteshim",
        sum = "h1:GMbSa7Pjjk4kjF8XURz5uMLe2PbN98e6t00sp0rx2Eo=",
        version = "v1.1.12",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:YSYC7Kh31bPtfJwMCa+cxoSymw2EJxvgXNi1B3IvwE8=",
        version = "v0.36.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:aQHa1SyUhpqxAw1fY21x2z2OS5RLtMJOCj7tN4oq8mw=",
        version = "v0.26.0",
    )
    go_repository(
        ...
        sum = "h1:lT1D3OfO+wIi9UFolCrifbjUUgu7CpLca0AD8ghRLI8=",
        version = "v0.26.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xmrzoKR9CyNdzxBmXV7jW9Ln8WMrwRK6hGbbf69o4T0=",
        version = "v0.26.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:PaBZQdo+iSDyHT053FjUCgZQ/9uqVwPOcl7KSWhKn6w=",
