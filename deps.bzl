...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:UgUXFYUuoy2NAkwoCFILrShZdH6vcFTRJjOplC69FoA=",
        version = "v0.15.10",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:RT9kM8MZLZIsPTH+HKQEP5yaAk3yd/VBzlINaRjXs8k=",
        version = "v2.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CJ9zlyXAbq0FIW8CD7HHyozCMBpDSiH7EdrSTCZcZFY=",
        version = "v0.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:8kl2ifbNffD440MyvHtPaIz1mw4mGKVgWqM0nL+oyu4=",
        version = "v0.25.0",
    )
    go_repository(
        ...
        sum = "h1:XBnTc2Fi+w818jcJGzhiJKQuXl8479sZ4FhtV5hVJ1Q=",
        version = "v0.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:haVKlLkPCFZhkcqB6WCvpVxftrg6+FK5x1ZuaIDaQ5Y=",
        version = "v0.25.0",
    )
    go_repository(
        name = "io_k8s_klog_v2",
    ...
    go_repository(
        ...
        sum = "h1:/Wn1cFqo8ik3iee1EvpxYre3bkWsGLXzLQI6uCCAkQc=",
        version = "v0.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GFXyyxtPnHFKqXr3ZG8/X0+0K9sl69lejStlPn2WQyM=",
        version = "v0.16.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:y/MYONZ/bsld9kHwqgBX2uPggnUr5hahpjwt9/jrHlI=",
        version = "v3.10.0",
    )
